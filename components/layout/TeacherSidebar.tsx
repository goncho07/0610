...
const TeacherSidebar: React.FC = () => {
  ...
  const linkClasses = "flex items-center px-4 py-3.5 text-slate-600 dark:text-slate-100 rounded-lg hover:bg-indigo-100 dark:hover:bg-slate-800 hover:text-indigo-700 dark:hover:text-indigo-400 transition-all duration-150 group relative font-medium";
